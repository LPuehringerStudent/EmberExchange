            ...
            schemas: {
                ...
                StoveType: {
                    ...
                    properties: {
                        ...
                        rarity: { type: "string", enum: ["common", "rare", "epic", "legendary", "limited", "secret"], description: "Rarity level" },
                ...
                PlayerStatistics: {
                    ...
                    properties: {
                        ...
                        bestDropRarity: { type: "string", enum: ["common", "rare", "epic", "legendary", "limited", "secret"], nullable: true, description: "Best rarity ever dropped" },
                        ...
                        rarestStoveOwned: { type: "string", enum: ["common", "rare", "epic", "legendary", "limited", "secret"], nullable: true, description: "Rarest stove owned" },

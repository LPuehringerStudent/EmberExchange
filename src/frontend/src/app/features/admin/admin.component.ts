    ...
    <div class="flex min-h-[calc(100vh-4rem)]">
      ...
      <aside class="w-56 bg-surface border-r border-[rgba(232,93,4,0.15)] p-4">
        ...
        <nav class="flex flex-col gap-1">
          ...
          <a routerLink="/admin/banned-ips" routerLinkActive="active-admin-link"
             class="px-3 py-2 rounded-lg text-sm font-medium text-text-secondary hover:bg-[rgba(232,93,4,0.1)] hover:text-accent transition-colors">
            Banned IPs
          </a>
          <a routerLink="/admin/request-logs" routerLinkActive="active-admin-link"
             class="px-3 py-2 rounded-lg text-sm font-medium text-text-secondary hover:bg-[rgba(232,93,4,0.1)] hover:text-accent transition-colors">
            Request Logs
          </a>
          <a routerLink="/admin/codes" routerLinkActive="active-admin-link"
             class="px-3 py-2 rounded-lg text-sm font-medium text-text-secondary hover:bg-[rgba(232,93,4,0.1)] hover:text-accent transition-colors">
            Codes
          </a>
        </nav>
